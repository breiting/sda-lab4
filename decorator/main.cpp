...
class LoggingDecorator final : public IService {
   public:
    explicit LoggingDecorator(std::unique_ptr<IService> inner) : m_Inner(std::move(inner)) {
    }
...
class TimingDecorator final : public IService {
   public:
    explicit TimingDecorator(std::unique_ptr<IService> inner) : m_Inner(std::move(inner)) {
    }
